...
@interface UIView (ZZSArtboardButton)

- (nullable UIImage *)snapshotImage;

@end

@implementation UIView (ZZSArtboardButton)
...
@interface CALayer (ZZSArtboardButton)

- (nullable UIImage *)snapshotImage;

@end

@implementation CALayer (ZZSArtboardButton)
...
@interface ZZSArtboardButton ()

@property (nonatomic, assign)   ZZSArtboardType      type;
...
@implementation ZZSArtboardButton
...
- (void)setType:(ZZSArtboardType)type {
    _type = type;
    switch (type) {
        case ZZSArtboardTypeUp: {
